...
class ControllerExtensionModuleOctPopupCallPhone extends Controller {
    ...
    $data['oct_luxury_data'] = $oct_luxury_data = $this->config->get('oct_luxury_data');
  ...
  public function send() {
    ...
    if (isset($this->request->post['telephone'])) {
      if ((isset($oct_popup_call_phone_data['telephone']) && $oct_popup_call_phone_data['telephone'] == 2) && (utf8_strlen(str_replace(array('_','-','(',')','+'), "", $this->request->post['telephone'])) < 3 || utf8_strlen(str_replace(array('_','-','(',')','+'), "", $this->request->post['telephone'])) > 32)) {
    ...
    if (!isset($json['error'])) {
      ...
      if ($oct_popup_call_phone_data['notify_status']) {
        ...
        $mail->setTo($oct_popup_call_phone_data['notify_email']);
