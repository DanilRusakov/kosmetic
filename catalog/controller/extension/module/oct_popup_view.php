...
class ControllerExtensionModuleOctPopupView extends Controller {
  public function index() {
    ...
    if ($product_info) {
      ...
      $image_width = ($oct_popup_view_data['image_width']) ? $oct_popup_view_data['image_width'] : '300';
      $image_height = ($oct_popup_view_data['image_height']) ? $oct_popup_view_data['image_height'] : '300';
      ...
      $image_additional_width = ($oct_popup_view_data['image_additional_width']) ? $oct_popup_view_data['image_additional_width'] : '59';
      $image_additional_height = ($oct_popup_view_data['image_additional_height']) ? $oct_popup_view_data['image_additional_height'] : '59';
