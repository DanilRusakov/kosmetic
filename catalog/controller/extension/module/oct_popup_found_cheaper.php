...
class ControllerExtensionModuleOctPopupFoundCheaper extends Controller {
  ...
  public function send() {
    ...
    if (isset($this->request->post['telephone'])) {
      if ((isset($oct_popup_found_cheaper_data['telephone']) && $oct_popup_found_cheaper_data['telephone'] == 2) && (utf8_strlen(str_replace(array('_','-','(',')','+'), "", $this->request->post['telephone'])) < 3 || utf8_strlen(str_replace(array('_','-','(',')','+'), "", $this->request->post['telephone'])) > 32)) {
    ...
    if (!isset($json['error'])) {
      ...
      if ($oct_popup_found_cheaper_data['notify_status']) {
        ...
        $mail->setTo($oct_popup_found_cheaper_data['notify_email']);
