...
class ControllerExtensionModuleOctPopupPurchase extends Controller {
  ...
  public function make_order() {
    ...
    if (isset($this->request->post['telephone'])) {
      if ((isset($oct_popup_purchase_data['telephone']) && $oct_popup_purchase_data['telephone'] == 2) && (utf8_strlen(str_replace(array('_','-','(',')','+'), "", $this->request->post['telephone'])) < 3 || utf8_strlen(str_replace(array('_','-','(',')','+'), "", $this->request->post['telephone'])) > 32)) {
