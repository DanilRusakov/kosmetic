...
<div class="container">
    <ul class="breadcrumb">
        ...
        <?php } else { ?>
        <li><span><?php echo $breadcrumb['text']; ?></span>
        </li>
        <?php } ?>
        <?php } ?> </ul>
</div>
...
<div class="container">
    <div class="row top-row news-top-row">
        <div class="col-sm-12">
            <h1 class="cat-header"><?php echo $heading_title; ?></h1> </div>
    </div>
    <div class="row">
        ...
        <article id="content" class="<?php echo $class; ?> reviews-content">
            <div class="store-rating">
                <?php echo $text_store_rating; ?> </div>
            <br/>
            <div class="form-group required">
                <div class="well well-sm">
                    <div class="text-left"> <a class="btn btn-primary" id="write-review"><i class="fa fa-comment-o" aria-hidden="true"></i> <?php echo $button_write_review; ?></a> </div>
                        ...
                        <div class="col-md-12">
                            <form class="form-review form-horizontal" id="form-review">
                                <div class="form-group required">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="author" value="" id="input-author" class="form-control"> </div>
                                </div>
                                <div class="form-group required">
                                ...
                                <div class="form-group required">
                                    ...
                                    <div class="col-sm-10">
                                        <?php echo $text_terms; ?>
                                        <input type="checkbox" name="terms" value="1" style="width: auto;" /> </div>
                                </div>
                                <?php } ?>
                                <?php if ($subjects) { ?>
                                ...
                                <div class="pull-left text-right button-group">
                                    <button type="button" id="button-review" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary">
                                        <?php echo $button_send_review; ?>
                                    </button>
                                    <a href="#" id="dismiss-write-review" style="display:none; margin-right: 10px;">
                                        <?php echo $button_dismiss_write_review; ?>
                                    </a>
                                </div>
                            </form>
                        </div>
            ...
            <div class="row sort-row">
                <div class="col-sm-12 col-md-3 col-md-offset-3 text-right">
                    <label class="control-label input-sort-reviews" for="input-sort">
                        <?php echo $text_sort; ?>
                    </label>
                </div>
                <div class="col-sm-12 col-md-3 text-right select-box">
                ...
                <div class="col-sm-12 col-md-2 text-right">
                    <label class="control-label input-sort-reviews" for="input-limit">
                        <?php echo $text_limit; ?>
                    </label>
                </div>
                <div class="col-sm-12 col-md-1 text-right select-box">
            ...
            <div class="product-layout product-list col-xs-12">
                <div class="row list-reviews-row">
                    <div class="col-sm-6 text-left"> <b><?php echo $review['author']; ?></b> <span class="small-date">(<?php echo $text_date_added; ?>              <?php echo $review['date_added']; ?>)</span> </div>
                    <div class="col-sm-6 text-right bigrating">
                        <div class="avg_rating"><span><?php echo $review['avg_rating']; ?></span>
                        </div>
                        <?php if ($review['review_subject_array']) { ?>
                        <div class="avg_rating_info">
                            <?php foreach ($review['review_subject_array'] as $review_subject) { ?> <b><?php echo $review_subject['name']; ?>:</b>
                            <?php echo $review_subject['rating']. "<br />"; ?>
                            <?php } ?> </div>
                        <?php } ?> </div>
                </div>
                <div class="well well-sm">
