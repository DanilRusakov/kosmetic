...
<?php } ?>	
  ...
  <div class="carousel-module-row-header"><a href="<?php echo $setting['titlelink']; ?>"><?php echo $title; ?></a></div>
    <div id="owl-carousel-module-<?php echo $setting['id']; ?>" class="owl-carousel owl-theme">
...
<script>
$('#owl-carousel-module-<?php echo $setting['id']; ?>').owlCarousel({
