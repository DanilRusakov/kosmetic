  ...
  <div id="content" class="col-sm-12">
    <div class="row">
      ...
      <div class="col-md-7 col-sm-12 left-info">
        <ul class="thumbnails">
        <?php if ($economy) { ?>
        <span id="popup-you-save" class="price-tax">-<?php echo $economy; ?>%</span>
        <?php } ?>
          ...
          <li>
            ...
            <?php } ?>
            <a class="thumbnail" title="<?php echo $product_name; ?>"><img src="<?php echo $thumb; ?>" title="<?php echo $product_name; ?>" alt="<?php echo $product_name; ?>" id="popup-main-image"/></a>
          </li>
          <?php } ?>
      ...
      <?php } ?>
      <?php } ?>
      <div class="col-md-5 col-sm-12 right-info">
          ...
          <div class="form-group<?php echo ($option['required'] ? ' required' : ''); ?>">
            ...
            <div class="number">
              <div class="frame-change-count">
                <div class="btn-plus">
                  <button type="button" id="superplus" onclick="$(this).parent().parent().next().val(~~$(this).parent().parent().next().val()+1); popup_update_prices('<?php echo $product_id; ?>');" class="main-color1">
                    <span class="icon-plus"><i class="fa fa-plus"></i></span>
                  </button>
                </div>
                <div class="btn-minus">
                  <button type="button" id="superminus" onclick="$(this).parent().parent().next().val(~~$(this).parent().parent().next().val()-1); popup_update_prices('<?php echo $product_id; ?>');" class="main-color1">
            ...
            <?php } ?>
            <button type="button" id="button-cart" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-lg"><i class="fa fa-shopping-basket" aria-hidden="true"></i> <span class="button-cart-span"><?php echo $button_cart; ?></span></button>
            <?php if ($oct_popup_view_data['wishlist']) { ?>
            <button type="button" class="btn wishlist-btn" data-effect="mfp-zoom-out" onclick="get_oct_popup_add_to_wishlist('<?php echo $product_id; ?>');" title="<?php echo $button_wishlist; ?>"><i class="fa fa-heart"></i></button>
            <?php } ?>
            <?php if ($oct_popup_view_data['compare']) { ?>
            <button type="button" class="btn compare-btn" data-effect="mfp-zoom-out" onclick="get_oct_popup_add_to_compare('<?php echo $product_id; ?>');" title="<?php echo $button_compare; ?>"><i class="fa fa-sliders" aria-hidden="true"></i></button>
            <?php } ?>
