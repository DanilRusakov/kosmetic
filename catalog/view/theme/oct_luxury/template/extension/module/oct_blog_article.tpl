...
$('#news-<?php echo $module; ?>').owlCarousel({
  ...
  items: <?php if($position == "column_left" OR $position == "column_right") { echo 1; } else { echo 3; } ?>,

  itemsDesktop : [1599,<?php if($position == "column_left" OR $position == "column_right") { echo 1; } else { echo 3; } ?>],

  itemsDesktop : [1199,<?php if($position == "column_left" OR $position == "column_right") { echo 1; } else { echo 2; } ?>],
