...
class ModelExtensionModuleOctProductFilter extends Model {
  public function getProductIDs($global_id, $global_type, $store_id, $customer_group_id) {
    if ($global_type == 'category') {
      ...
      if (!$result) {
        $query = $this->db->query("SELECT DISTINCT p.product_id FROM ".DB_PREFIX."product p LEFT JOIN ".DB_PREFIX."product_to_category p2c ON (p.product_id = p2c.product_id) LEFT JOIN ".DB_PREFIX."product_to_store p2s ON (p.product_id = p2s.product_id) WHERE p.status = '1' AND p.date_available <= NOW() AND p2s.store_id = '".(int)$store_id."' AND p2c.category_id = '".(int)$global_id."'")->rows;
      ...
      if (!$result) {
        $query = $this->db->query("SELECT DISTINCT p.product_id FROM ".DB_PREFIX."product p LEFT JOIN ".DB_PREFIX."product_to_store p2s ON (p.product_id = p2s.product_id) WHERE p.status = '1' AND p.date_available <= NOW() AND p2s.store_id = '".(int)$store_id."' AND p.manufacturer_id = '".(int)$global_id."'")->rows;
      ...
      if (!$result) {
        $query = $this->db->query("SELECT DISTINCT p.product_id FROM ".DB_PREFIX."product p LEFT JOIN ".DB_PREFIX."product_to_store p2s ON (p.product_id = p2s.product_id) WHERE p.status = '1' AND p.date_available <= NOW() AND p2s.store_id = '".(int)$store_id."'")->rows;
  ...
  public function getFilterTotalSpecialOnly($global_id, $global_type, $store_id, $customer_group_id, $language_id, $lead_time_status = false, $data = array()) {
    ...
    if ($product_ids) {
      ...
      if (isset($data['low_price']) && (isset($data['high_price']) && !empty($data['high_price']))) {
        ...
        $sql .= "((CASE WHEN(SELECT price FROM ".DB_PREFIX."product_special ps WHERE ps.product_id = p.product_id AND ps.customer_group_id = '".(int)$data['filter_data']['customer_group_id']."' AND ((ps.date_start = '0000-00-00' OR ps.date_start < NOW()) AND (ps.date_end = '0000-00-00' OR ps.date_end > NOW())) ORDER BY ps.priority ASC, ps.price ASC LIMIT 1) > 0 THEN (SELECT price FROM ".DB_PREFIX."product_special ps WHERE ps.product_id = p.product_id AND ps.customer_group_id = '".(int)$data['filter_data']['customer_group_id']."' AND ((ps.date_start = '0000-00-00' OR ps.date_start < NOW()) AND (ps.date_end = '0000-00-00' OR ps.date_end > NOW())) ORDER BY ps.priority ASC, ps.price ASC LIMIT 1) ELSE p.price END) BETWEEN ".$this->currency->convert($data['low_price'], $this->session->data['currency'], $this->config->get('config_currency'))." AND ".$this->currency->convert($data['high_price'], $this->session->data['currency'], $this->config->get('config_currency')).")";
      }
      ...
      if (isset($data['manufacturer']) && !empty($data['manufacturer'])) {
        ...
        if (is_array($data['manufacturer'])) {
          ...
          if ($implode_manufacturer) {
            $sql .= "(".implode(' '.$data['filter_data']['manufacturer_logic_between_manufacturers'].' ', $implode_manufacturer).")";
          }
        } else {
      ...
      if (isset($data['rating']) && !empty($data['rating'])) {
        ...
        if (is_array($data['rating'])) {
          foreach ($data['rating'] as $rating) {
            $implode_rating[] = "p.product_id IN (SELECT product_id FROM ".DB_PREFIX."review WHERE product_id = p.product_id AND rating = '".$rating."' GROUP BY rating)";
          }
        } else {
          if ($data['rating']) {
            $implode_rating[] = "p.product_id IN (SELECT product_id FROM ".DB_PREFIX."review WHERE product_id = p.product_id AND rating = '".$data['rating']."' GROUP BY rating)";
          }
        }
  ...
  public function getFilterTotalManufacturers($global_id, $global_type, $store_id, $customer_group_id, $language_id, $data = array()) {
    ...
    if ($product_ids) {
      ...
      if (isset($data['low_price']) && (isset($data['high_price']) && !empty($data['high_price']))) {
        ...
        if (isset($data['special_only']) && !empty($data['special_only'])) {
          $sql .= "((SELECT ps.price FROM ".DB_PREFIX."product_special ps WHERE ps.product_id = p.product_id AND ps.customer_group_id = '".(int)$data['filter_data']['customer_group_id']."' AND ((ps.date_start = '0000-00-00' OR ps.date_start < NOW()) AND (ps.date_end = '0000-00-00' OR ps.date_end > NOW())) ORDER BY ps.priority ASC, ps.price ASC LIMIT 1) BETWEEN ".$this->currency->convert($data['low_price'], $this->session->data['currency'], $this->config->get('config_currency'))." AND ".$this->currency->convert($data['high_price'], $this->session->data['currency'], $this->config->get('config_currency')).")";
        } else {
          $sql .= "((CASE WHEN(SELECT price FROM ".DB_PREFIX."product_special ps WHERE ps.product_id = p.product_id AND ps.customer_group_id = '".(int)$data['filter_data']['customer_group_id']."' AND ((ps.date_start = '0000-00-00' OR ps.date_start < NOW()) AND (ps.date_end = '0000-00-00' OR ps.date_end > NOW())) ORDER BY ps.priority ASC, ps.price ASC LIMIT 1) > 0 THEN (SELECT price FROM ".DB_PREFIX."product_special ps WHERE ps.product_id = p.product_id AND ps.customer_group_id = '".(int)$data['filter_data']['customer_group_id']."' AND ((ps.date_start = '0000-00-00' OR ps.date_start < NOW()) AND (ps.date_end = '0000-00-00' OR ps.date_end > NOW())) ORDER BY ps.priority ASC, ps.price ASC LIMIT 1) ELSE p.price END) BETWEEN ".$this->currency->convert($data['low_price'], $this->session->data['currency'], $this->config->get('config_currency'))." AND ".$this->currency->convert($data['high_price'], $this->session->data['currency'], $this->config->get('config_currency')).")";
        }
      }
  ...
  public function getFilterTotalAttributeValues($global_id, $global_type, $store_id, $customer_group_id, $language_id, $data = array()) {
    ...
    if ($product_ids) {
      ...
      $sql .= " WHERE fpa.product_id IN (".implode(',', $product_ids).")";
      ...
      if (isset($data['attribute']) && !empty($data['attribute'])) {
        if ($data['filter_data']['attribute_logic_between_attribute'] == 'AND') {
          ...
          if ($implode_product_attributes) {
            $sql .= " AND fpa.language_id = '".(int)$language_id."' ".$data['filter_data']['attribute_logic_with_other']." (" . implode(' AND ', $implode_product_attributes) . ")";
          }
        } else {
          $sql .= " AND fpa.language_id = '".(int)$language_id."'";
        }
      }
  ...
  public function getFilterTotalOptionValues($global_id, $global_type, $store_id, $customer_group_id, $language_id, $data = array()) {
    ...
    if ($product_ids) {
      ...
      $sql .= "WHERE fpo.product_id IN (".implode(',', $product_ids).") ";
      ...
      if (isset($data['option']) && !empty($data['option'])) {
        if ($data['filter_data']['option_logic_between_option'] == 'AND') {
          ...
          if ($implode_product_options) {
            $sql .= " AND fpo.language_id = '".(int)$language_id."' ".$data['filter_data']['option_logic_with_other']." (" . implode(' AND ', $implode_product_options) . ")";
          }
        } else {
          $sql .= " AND fpo.language_id = '".(int)$language_id."'";
        }
      }
  ...
  public function getFilterTotalStickers($global_id, $global_type, $store_id, $customer_group_id, $language_id, $lead_time_status = false, $data = array()) {
    ...
    if ($product_ids) {
      ...
      $sql .= " WHERE fpst.product_id IN (".implode(',', $product_ids).") ";
      ...
      if (isset($data['sticker']) && !empty($data['sticker'])) {
        if ($data['filter_data']['sticker_logic_between_sticker'] == 'AND') {
          ...
          if ($implode_product_stickers) {
            $sql .= " AND fpst.language_id = '".(int)$language_id."' ".$data['filter_data']['sticker_logic_with_other']." (" . implode(' AND ', $implode_product_stickers) . ")";
          }
        } else {
          $sql .= " AND fpst.language_id = '".(int)$language_id."' ";
        }
      }
  ...
  public function getFilterTotalStandardValues($global_id, $global_type, $store_id, $customer_group_id, $language_id, $data = array()) {
    ...
    if ($product_ids) {
      ...
      $sql .= "WHERE fpsd.product_id IN (".implode(',', $product_ids).") ";
      ...
      if (isset($data['standard']) && !empty($data['standard'])) {
        if ($data['filter_data']['standard_logic_between_standard'] == 'AND') {
          ...
          if ($implode_product_standards) {
            $sql .= " AND fpsd.language_id = '".(int)$language_id."' ".$data['filter_data']['standard_logic_with_other']." (" . implode(' AND ', $implode_product_standards) . ")";
          }
        } else {
          $sql .= " AND fpsd.language_id = '".(int)$language_id."'";
        }
      }
  ...
  public function getProducts($data, $type) {
    ...
    if ($type == 'products') {
      ...
      if ($this->checkOctIfTableExist(DB_PREFIX . "manufacturer_description")) {
